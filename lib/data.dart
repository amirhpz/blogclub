...
class AppDatabase {
  ...
  static List<OnBourdingItem> get onBourdingItems {
    List<OnBourdingItem> items = [];
    for (var i = 0; i < 4; i++) {
      items.add(OnBourdingItem('Read the article you want instantly',
...
class OnBourdingItem {
  final String title;
  final String deccription;

  OnBourdingItem(this.title, this.deccription);
}
